# feb/04/2023 10:26:15 by RouterOS 6.49.7
...
add action=dst-nat chain=dstnat comment=pvs dst-port=3499 in-interface=wan \
    protocol=tcp src-address-list=!perebor_portov_drop to-addresses=\
    10.34.7.250 to-ports=3389
add action=dst-nat chain=dstnat comment=pvs dst-port=3499 in-interface=wan \
    protocol=tcp src-address-list=whitelist to-addresses=10.34.7.250 \
    to-ports=3389
add action=dst-nat chain=dstnat comment=pvs dst-port=34999 in-interface=wan \
    protocol=tcp to-addresses=10.34.7.250 to-ports=3389
add action=dst-nat chain=dstnat comment="Oleg Krikun" dst-port=33099 \
    in-interface=wan protocol=tcp to-addresses=10.34.7.248 to-ports=3389
...
add action=dst-nat chain=dstnat comment=LoskInstr dst-port=35033 \
    in-interface=wan protocol=tcp to-addresses=10.34.7.249 to-ports=3389
