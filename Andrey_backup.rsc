# sep/13/2020 12:42:45 by RouterOS 6.47.3
...
add address=10.34.1.247 client-id=1:0:c:29:55:0:ca mac-address=\
    00:0C:29:55:00:CA server=dhcp1
...
add address=136.243.1.236 list=whitelist
add address=80.82.0.0/16 list=blacklist
add address=45.141.0.0/16 list=blacklist
add address=194.61.55.0/24 list=blacklist
add address=194.61.54.0/24 list=blacklist
...
add action=dst-nat chain=dstnat comment="RDP Ghenya Losk" dst-port=33300 \
    protocol=tcp to-addresses=10.34.1.247 to-ports=3389
...
add action=dst-nat chain=dstnat comment="RDP Arbuz office Somovskaya" \
    disabled=yes dst-port=33489 protocol=tcp src-address=46.201.231.221 \
    to-addresses=10.34.1.253 to-ports=3389
add action=dst-nat chain=dstnat disabled=yes dst-port=35489 protocol=tcp \
    to-addresses=10.34.1.249 to-ports=3389
...
add disabled=yes name=Victoriya password=Arbuz159Arbuz profile=vpn
add name=magaz20 password=20t123987456 profile=vpn_rout_Lance
add disabled=yes name=Mishanya password=Mihaaalich profile=vpn
